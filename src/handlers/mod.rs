//! Handler FE command handling: connect, handshake, checkin, commit, rollback, terminate, query_vehicle_boo, checkout_reserve, checkout_commit, checkout_rollback, processor.
