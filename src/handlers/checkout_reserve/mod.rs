...
/// Handles CHECKOUT_RESERVE_BOO (2AZ): parse request, normalize content, build CHECKOUT_RESERVE_BOO_RESP (2BZ) and return encrypted.
...
pub async fn handle_checkout_reserve_boo(
    ...
    resp.status = 0; // success; spec: 0 = success, multiple calls still return success
