//! Protocol message structures VDTC (BOO2): CONNECT, HANDSHAKE, CHECKIN_RESERVE_BOO, COMMIT_BOO, ...
...
impl fmt::Debug for VDTC_REQUEST {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_REQUEST")
...
impl fmt::Debug for VDTC_CONNECT {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CONNECT")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
impl fmt::Debug for VDTC_CONNECT_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CONNECT_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
impl fmt::Debug for VDTC_SHAKE {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_SHAKE")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
impl fmt::Debug for VDTC_SHAKE_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_SHAKE_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_TERMINATE - Bản tin terminate
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_TERMINATE {
...
impl fmt::Debug for VDTC_TERMINATE {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_TERMINATE")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_TERMINATE_RESP - Bản tin terminate response
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_TERMINATE_RESP {
...
impl fmt::Debug for VDTC_TERMINATE_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_TERMINATE_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKIN_RESERVE_BOO {
...
impl fmt::Debug for VDTC_CHECKIN_RESERVE_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKIN_RESERVE_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_QUERY_VEHICLE_BOO {
...
impl fmt::Debug for VDTC_QUERY_VEHICLE_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_QUERY_VEHICLE_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_QUERY_VEHICLE_BOO_RESP {
...
impl fmt::Debug for VDTC_QUERY_VEHICLE_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_QUERY_VEHICLE_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_LOOKUP_VEHICLE {
...
impl fmt::Debug for VDTC_LOOKUP_VEHICLE {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_LOOKUP_VEHICLE")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_LOOKUP_VEHICLE_RESP {
...
impl fmt::Debug for VDTC_LOOKUP_VEHICLE_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_LOOKUP_VEHICLE_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKIN_RESERVE_BOO_RESP {
...
impl fmt::Debug for VDTC_CHECKIN_RESERVE_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKIN_RESERVE_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
impl fmt::Debug for VDTC_COMMIT_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_COMMIT_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_COMMIT_BOO_RESP {
...
impl fmt::Debug for VDTC_COMMIT_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_COMMIT_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKIN_ROLLBACK_BOO - Bản tin checkin rollback
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKIN_ROLLBACK_BOO {
    pub message_length: i32,     // 4 bytes - 152
...
impl fmt::Debug for VDTC_CHECKIN_ROLLBACK_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKIN_ROLLBACK_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKIN_ROLLBACK_BOO_RESP - Bản tin checkin rollback response
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKIN_ROLLBACK_BOO_RESP {
    pub message_length: i32, // 4 bytes - 84
...
impl fmt::Debug for VDTC_CHECKIN_ROLLBACK_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKIN_ROLLBACK_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_RESERVE_BOO - Bản tin checkout reserve
/// Size tùy thuộc vào số dòng chi tiết (rating_detail_line)
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_RESERVE_BOO {
...
impl fmt::Debug for VDTC_CHECKOUT_RESERVE_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_RESERVE_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_RESERVE_BOO_RESP - Bản tin checkout reserve response
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_RESERVE_BOO_RESP {
...
impl fmt::Debug for VDTC_CHECKOUT_RESERVE_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_RESERVE_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_COMMIT_BOO - Bản tin checkout commit (3AZ), 188 byte theo spec.
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_COMMIT_BOO {
    pub message_length: i32, // 4 bytes - 188
    pub command_id: i32,     // 4 bytes - Mã bản tin: 154
    pub version_id: i32,     // 4 bytes - Phiên bản bản tin
    pub request_id: i64,     // 8 bytes - Long
    pub session_id: i64,     // 8 bytes - Long
    pub timestamp: i64,      // 8 bytes - Long - epoch ms
    pub tid: String,         // 24 bytes - String - Mã TID
    pub etag: String,        // 24 bytes - String - Mã EPC/ETAG
    pub ticket_in_id: i64,   // 8 bytes - Long - Mã giao dịch trạm vào
    pub hub_id: i64,         // 8 bytes - Long - Mã ghi nhận đồng bộ tại hub
    pub ticket_out_id: i64,  // 8 bytes - Long - Mã giao dịch trạm ra
    pub ticket_eTag_id: i64, // 8 bytes - Long - Mã giao dịch Boo quản lý thẻ
    pub station_in: i32,     // 4 bytes - Int - Mã trạm vào
    pub lane_in: i32,        // 4 bytes - Int - Mã làn vào
    pub station_out: i32,    // 4 bytes - Int - Mã trạm ra
    pub lane_out: i32,       // 4 bytes - Int - Mã làn ra
    pub plate: String,       // 20 bytes - String - Biển số
    pub trans_amount: i32,   // 4 bytes - Int - Số tiền cần trừ phí
    pub trans_datetime: i64, // 8 bytes - Long - epoch datetime, tính đến giây
    pub general1: [u8; 8],   // 8 bytes
    pub general2: [u8; 16],  // 16 bytes
}

impl fmt::Debug for VDTC_CHECKOUT_COMMIT_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_COMMIT_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_COMMIT_BOO_RESP - Bản tin checkout commit response (3BZ), 96 byte theo spec.
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_COMMIT_BOO_RESP {
    pub message_length: i32, // 4 bytes - 96
    pub command_id: i32,     // 4 bytes - Mã bản tin: 155
    pub version_id: i32,     // 4 bytes
    pub request_id: i64,     // 8 bytes
    pub session_id: i64,     // 8 bytes
    pub timestamp: i64,      // 8 bytes - epoch ms
    pub ticket_in_id: i64,   // 8 bytes
    pub hub_id: i64,         // 8 bytes
    pub ticket_eTag_id: i64, // 8 bytes
    pub ticket_out_id: i64,  // 8 bytes
    pub status: i32,         // 4 bytes - 0: Thành công
    pub general1: [u8; 8],   // 8 bytes
    pub general2: [u8; 16],  // 16 bytes
}

impl fmt::Debug for VDTC_CHECKOUT_COMMIT_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_COMMIT_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_ROLLBACK_BOO - Bản tin checkout rollback
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_ROLLBACK_BOO {
...
impl fmt::Debug for VDTC_CHECKOUT_ROLLBACK_BOO {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_ROLLBACK_BOO")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
...
/// VDTC_CHECKOUT_ROLLBACK_BOO_RESP - Bản tin checkout rollback response
#[allow(dead_code)]
#[derive(Default)]
pub struct VDTC_CHECKOUT_ROLLBACK_BOO_RESP {
    pub message_length: i32, // 4 bytes - 96
...
impl fmt::Debug for VDTC_CHECKOUT_ROLLBACK_BOO_RESP {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("VDTC_CHECKOUT_ROLLBACK_BOO_RESP")
            .field("message_length", &self.message_length)
            .field("command_id", &format_args!("0x{:02X}", self.command_id))
            .field("version_id", &self.version_id)
            .field("request_id", &self.request_id)
